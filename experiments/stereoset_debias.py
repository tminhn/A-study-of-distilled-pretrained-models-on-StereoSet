...
parser.add_argument(
    ...
    action="store",
    type=str,
    default="DropoutDistilGPT2LMHeadModel",
    choices=[
        ...
        "CDAGPT2LMHeadModel",
        "DropoutDistilRobertaForMaskedLM",
...
parser.add_argument(
    ...
    choices=["distilroberta-base","distilgpt2","distilbert-base-uncased", "bert-base-uncased", "albert-base-v2", "roberta-base", "gpt2"],
...
if __name__ == "__main__":
    ...
    #args.seed = 1
    #args.load_path = f"{args.persistent_dir}/results/gpt2-dropout-0.10-0.10-wikitext (1)"
    name_with_config = os.path.basename(os.path.normpath(args.load_path)) # get the name of the folder
    #args.model = "DropoutGPT2LMHeadModel"
    #args.model_name_or_path = "gpt2"

    experiment_id = generate_experiment_id(
        name="stereoset",
        model_name_or_path=name_with_config,
        seed=args.seed,
    )
